...
urlpatterns = [
    ...
    path("admin/college-profile/", hod_views.manage_college_profile, name='manage_college_profile'),
    path("admin/syllabus/", hod_views.manage_syllabus, name='manage_syllabus'),
    path("admin/syllabus/delete/<int:syllabus_id>/", hod_views.delete_syllabus, name='delete_syllabus'),
    ...
    path("staff/student-directory/", staff_views.staff_student_directory, name='staff_student_directory'),
    path("staff/syllabus/", staff_views.staff_syllabus_list, name='staff_syllabus_list'),
    ...
    path("student/fcmtoken/", student_views.student_fcmtoken,
     ...
     path("student/syllabus/", student_views.student_syllabus_list, name='student_syllabus_list'),
    ...
    # Advanced modules
    path("admin/advanced/", advanced_views.admin_advanced_dashboard, name='admin_advanced_dashboard'),
    path("admin/departments/", advanced_views.admin_department_management, name='admin_department_management'),
    path("admin/fees/", advanced_views.admin_fee_management, name='admin_fee_management'),
    path("admin/exams/", advanced_views.admin_exam_management, name='admin_exam_management'),
    path("admin/reports-certificates/", advanced_views.admin_reports_certificates, name='admin_reports_certificates'),
    path("search/", advanced_views.unified_search, name='unified_search'),
    path("hod/home/", advanced_views.hod_dashboard, name='hod_dashboard'),
    path("hod/department-data/", advanced_views.hod_department_data, name='hod_department_data'),
    path("hod/approvals/", advanced_views.hod_approvals, name='hod_approvals'),
    path("hod/notices/", advanced_views.hod_notice_board, name='hod_notice_board'),
    path("staff/assignments/", advanced_views.staff_assignments, name='staff_assignments'),
    path("staff/notes/", advanced_views.staff_notes, name='staff_notes'),
    path("staff/online-classes/", advanced_views.staff_online_classes, name='staff_online_classes'),
    path("staff/lectures/", advanced_views.staff_online_classes, name='staff_lecture_panel'),
    path("staff/air-canvas/", advanced_views.staff_air_canvas, name='staff_air_canvas'),
    path("attendance/face-center/", advanced_views.face_attendance_center, name='face_attendance_center'),
    path("student/services/", advanced_views.student_services, name='student_services'),
